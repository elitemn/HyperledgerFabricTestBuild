This repository consists of an Azure ARM template that will create an Azure Linux VM (Umbuntu 22.04) platform and underlying infrastructure, then a the shell script will 
