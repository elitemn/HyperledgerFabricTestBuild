This repostory consists of an Azure ARM template that will create the underlying Azure Linux VM (Umbuntu 22.04) platform and underlying unfrastructure, then a the shell script will 
